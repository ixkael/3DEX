...
*********************************************************************** ADCK0038
      ...
      IMPLICIT REAL*8(A-H, O-Z), INTEGER*4(I-N)                         ADCK0040
      INTEGER*4 MAXRT,IERR,NRF                                          ADCK0041
      DIMENSION  ROOTIS(MAXRT,2), ROOTS(MAXRT), VAR(MAXRT)              ADCK0042
      INTEGER*4  INF                                                    ADCK0043
...
*                                                                     * ADCK0825
*********************************************************************** ADCK0826
      IMPLICIT REAL*8(A-H, O-Z), INTEGER*4(I-N)                         ADCK0827
      PARAMETER (ONE = 1.D0, TWO = 2.D0)                                ADCK0828
      INTEGER*4 INF                                                     ADCK0829
...
*                                                                     * ADCK0924
*********************************************************************** ADCK0925
      IMPLICIT REAL*8(A-H, O-Z), INTEGER*4(I-N)                         ADCK0926
      PARAMETER (ZERO = 0.D0, ONE = 1.D0)                               ADCK0927
      INTEGER*4 INF                                                     ADCK0928
...
*                                                                     * ADCK1053
*********************************************************************** ADCK1054
      IMPLICIT REAL*8(A-H, O-Z), INTEGER*4(I-N)                         ADCK1055
      PARAMETER (ZERO = 0.D0, ONE = 1.D0, TWO = 2.D0, THREE = 3.D0)     ADCK1056
      INTEGER*4  INF                                                    ADCK1057
